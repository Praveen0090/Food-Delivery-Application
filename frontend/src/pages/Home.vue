    ...
    <div>
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/biryani-img.jpg" alt="">
                <h3>Biryani</h3>
            </router-link>
            ...
            <router-link @click="scrollToTop()" to="/menu" class="box">
                <img src="../assets/images/cake-img.png" alt="">
                <h3>Cake</h3>
            </router-link>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                <div class="grid col-md-4">
                    <img src="../assets/images/biryani/mutton.png" alt="">
                    <div class="content">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/cake/rose.png" alt="">
                    <div class="content center">
                        <span>special offer</span>
                        <h3>upto 25% extra off</h3>
                        <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
                    </div>
                </div>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <p>Food to customers is always guaranteed of the best quality. Our dishes are made by Best in the business, promising to bring explosive, delicate, impressive flavors. Our delivery
