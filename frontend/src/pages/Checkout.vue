                    ...
                    <div class="form-group">
                        <div class="form-group">
                            <input type="radio" name="payment" value="cash" id="paymentCash"
                                v-model="checkoutObj.paymentMethod" /><span>COD</span>
                            <input type="radio" name="payment" value="card" id="paymentCard"
                                v-model="checkoutObj.paymentMethod" /><span>Card</span>
                        </div>
            ...
            if (!this.checkoutObj.paymentMethod) {
                ...
                if (!this.cardObj.number) {
                    ...
                    if (this.cardObj.number.length != 16) {
                        this.errorObj.numErr.push('Debit card numbers must have exactly 16 digits');
                    }

                    if (!/[0-9]{16}/.test(this.cardObj.number)) {
                        this.errorObj.numErr.push('Debit card numbers can only contain numbers');
                    }
                }
